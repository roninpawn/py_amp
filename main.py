...
track = Label(app, "GUI/title_bar_303x28.png", "4. Track 3 (5:04)", ui_font,
...
progress_bar = Image(app, "GUI/progress_trough_487x20.png").place(28, 152)
progress_handle = Drag(progress_bar, "GUI/progress_handle_58x20.png").place(0, 0)
